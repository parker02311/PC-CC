...
class Importer extends preact.Component {
    ...
    render(props, state) {
        return (preact.h("div", { className: 'ImporterMenu_content' },
            // preact.h(Button, { label: Format.stringLiteral('PC:CC'), onSelect: () => Engine.sendEvent('ImporterImport') }),
            // preact.h("div", { className: 'ImporterMenu_content' },
            ...
            // )
            // , tooltipInputName: isGamepad ? undefined : NewtonInput.HUDManagement
        ))
    };
}