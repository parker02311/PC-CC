        ...
        <div>
            <main className="container mx-auto px-4 py-8 max-w-2xl flex-1">
                <div className="text-center mb-8">
                    ...
                    <p className="text-ctp-subtext1">This is a single page website, <a className="text-ctp-mauve hover:text-ctp-pink transition-all" href="/">click here to return</a></p>
                </div>
            </main>
        </div>
    )
